...
int main(){
	...
	if (type=='v'){
		...
		cout << " Temps d'éxécution de l'addition de deux vecteurs de taille " << n << " : " << time_addition << endl;
		...
		cout << "Temps d'éxécution de la somme des éléments d'un vecteur de taille " << n << " : " << time_somme << endl;
		...
		cout << "Temps d'éxécution de la multiplication d'un vecteur de taille " << n << " par un scalaire : " << time_multi << endl;
	}
		...
		int time_addition = chrono::duration_cast<chrono::microseconds> (end-start).count();
		cout << " Temps d'exécution de l'addition de deux matrices de taille " << n << " x " << m << " : " << time_addition << endl;
		...
		int time_somme = chrono::duration_cast<chrono::microseconds> (end-start).count();
		cout << "Temps d'exécution de la somme des éléments d'une matrice de taille " << n << " x " << m << "  : " << time_somme << endl;
		...
		int time_multi = chrono::duration_cast<chrono::microseconds> (end-start).count();
		cout << "Temps d'exécution de la multiplication d'une matrice de taille " << n << "x" << m << " par un scalaire : " << time_multi << endl;
		...
		cout << "Temps d'exécution de la multiplication d'une matrice et  de taille " << n << "x" << m << " par un vecteur de taille " << m << " : " << time_matvec << endl;
		...
		cout << "Temps d'exécution de la multiplication de 2 matrices de taille " << n << "x" << m << "  et " << m << "x" << n << " : " << time_matmat <<  endl;
	}
